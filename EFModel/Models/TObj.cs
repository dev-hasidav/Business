...
namespace EFModel.Models
{
    public partial class TObj
    {
        ...
        public string TmpEshopObjId { get; set; }
        public string TmpEshopIoId { get; set; }
        public int? RefEetprofil { get; set; }
        public string Ttext { get; set; }

        public ICollection<TObjpol> TObjpol { get; set; }
    }
}
