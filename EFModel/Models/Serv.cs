...
namespace EFModel.Models
{
    public partial class Serv
    {
        public Serv()
        {
            ServPredm = new HashSet<ServPredm>();
            ServStav = new HashSet<ServStav>();
            Servpol = new HashSet<Servpol>();
        }
        ...
        public ICollection<ServPredm> ServPredm { get; set; }
        public ICollection<ServStav> ServStav { get; set; }
        public ICollection<Servpol> Servpol { get; set; }
    }
}
