...
namespace EFModel.Models
{
    public partial class Ad
    {
        public Ad()
        {
            Addodaci = new HashSet<Addodaci>();
            Adgdpr = new HashSet<Adgdpr>();
            Aducet = new HashSet<Aducet>();
        }
        ...
        public ICollection<Addodaci> Addodaci { get; set; }
        public ICollection<Adgdpr> Adgdpr { get; set; }
        public ICollection<Aducet> Aducet { get; set; }
    }
}
