...
{
    public partial class TRekl
    {
        public TRekl()
        {
            TReklKomp = new HashSet<TReklKomp>();
            TReklPredm = new HashSet<TReklPredm>();
            TReklStav = new HashSet<TReklStav>();
        }
        ...
        public ICollection<TReklKomp> TReklKomp { get; set; }
        public ICollection<TReklPredm> TReklPredm { get; set; }
        public ICollection<TReklStav> TReklStav { get; set; }
    }
}
